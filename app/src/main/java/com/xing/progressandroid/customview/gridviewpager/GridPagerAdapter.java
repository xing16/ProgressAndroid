package com.xing.progressandroid.customview.gridviewpager;
...
public abstract class GridPagerAdapter<T> extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        final View view = LayoutInflater.from(context).inflate(R.layout.item_grid_category, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.rv_page);
